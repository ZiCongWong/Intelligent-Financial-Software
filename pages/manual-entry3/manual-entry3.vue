<template>
  <view>
    <view class="con">
      <view class="main">
        <view class="register">
          <image class="register-back" src="../../static/login-register/back.png" mode="" @click="backToIndex3"></image>
        ...
        <view class="main2">
          <view class="out" v-show="Inv==0">
            ...
            <view class="money">
              ...
              <p class="text">消费金额</p>
              <uni-easyinput class="uni-mt-5" trim="all" placeholder="输入消费金额" type="number" maxlength="15"
            ...
            <view class="seller">
              ...
              <p class="text">消费店家</p>
              <uni-easyinput class="uni-mt-5" trim="all" placeholder="输入消费店家" type="text" :inputBorder='false'
                v-model="merchants1"></uni-easyinput>
            </view>
            <hr class="ms">
            ...
            <view class="upload">
              ...
              <view class="upload-right">
                <!-- <view v-if="haveimg == 1" class="billimg">
            ...
            <view class="tips">
              ...
              <p class="text">备注</p>
              <textarea name="ar" id="" cols="30" rows="10" placeholder="输入备注" v-model="note1"></textarea>
            </view>
            <hr class="ms">
          ...
          <view class="in" v-show="Inv==1">
            ...
            <view class="money">
              <image src="../../static/manual-entry/note.png.png (3).png" mode=""></image>
              <p class="text">收入金额</p>
              <uni-easyinput class="uni-mt-5" trim="all" placeholder="输入收入金额" type="number" maxlength="15"
            ...
            <view class="seller">
              <image src="../../static/manual-entry/note.png.png (1).png" mode=""></image>
              <p class="text">收入来源</p>
              <uni-easyinput class="uni-mt-5" trim="all" placeholder="输入收入来源" type="text" :inputBorder='false'
                v-model="origin"></uni-easyinput>
            </view>
            <hr class="ms">
            <view class="upload">
              <view class="upload-left">
              ...
              <view class="upload-right">
                <!-- <view v-if="haveimg2 == 1" class="billimg">
                  <image :src="billimg" mode=""></image>
                </view> -->
            ...
            <view class="tips">
              <image src="../../static/manual-entry/note.png.png (2).png" mode=""></image>
              <p class="text">备注</p>
              <textarea name="ar" id="" cols="30" rows="10" placeholder="输入备注" v-model="note2"></textarea>
            </view>
            <hr class="ms">
