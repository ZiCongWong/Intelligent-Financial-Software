<template>
  <view class="con">
    <mynav2 :text="text"></mynav2>
    <tabbar2 :state="state"></tabbar2>
    <view class="my">
      <image src="../../static/my-b.png" mode="" class="my-bg"></image>
      <view class="app-set">
        <image src="../../static/qiehuan-w.png" mode="" @click="change"></image>
        <image src="../../static/set-w.png" mode="" @click="goSetting"></image>
      </view>
      <view class="my-box">
...
<script>
  ...
  import mynav2 from '../../components/mynav2/mynav2.vue'
  export default {
    data() {
      return {
        state: '5',
