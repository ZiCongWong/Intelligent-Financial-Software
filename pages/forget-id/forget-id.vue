<template>
	<view class="con">
		<view class="main">
			<view class="register">
				<image class="register-back" src="../../static/login-register/back.png" mode="" @click="backTocertificate"></image>
				<p class="title">忘记密码</p>
			</view>
			
			<view class="text-box">
				<view class="set-text">
					<p class="black">请输入您的账号</p>
				</view>
				
			</view>
			<view class="form">
				<view class="item" :class="'login_user ' + nameFocus">
					<input type="safe-password" class="input-ui u-border" placeholder="输入要更改密码的手机号"/>				
				</view>
			...
			<view class="tips-box">
				...
				<view class="all">
					<view class="tips">备注：请输入忘记密码的手机号，并通过验证码验证方可重置密码。</view>

				</view>
			</view>
			<view class="botton-ui" @click="goForgetCertificate()">
				<p class="denglu">获取验证码</p>
			</view>
