			...
			<view class="main">
				...
				<view class="main2">
					<view class="out" v-show="Inv==0">
						...
						<view class="money">
							...
							<uni-easyinput class="uni-mt-5" trim="all" :placeholder="money1" type="number"
								maxlength="15" :inputBorder='false' v-model="money1"></uni-easyinput>
						</view>
						<hr class="ms">
						<view class="seller">
							<image src="../../static/manual-entry/note.png.png (1).png" mode=""></image>
							<p class="text">消费店家</p>
							<uni-easyinput class="uni-mt-5" trim="all" :placeholder="merchants1" type="text"
                  ...
                  <view class="goods-price">单价:￥{{item.price}}</view>     
								...
								<goodsitem v-for="(item,index) in productList" :key="item.data" :text="item.data"
									:amount="item.amount" :price="item.price" @delitem="delitem(index)"
									@edit="edit(index,item)"></goodsitem>
							</view>
						</view>
						<view class="upload">
							...
							<view class="upload-right">
								...
								<uni-file-picker v-if="haveimg == 0" v-model="imageValue" fileMediatype="image"
					...
					<view class="in" v-show="Inv==1">
						...
						<view class="money">
							...
							<uni-easyinput class="uni-mt-5" trim="all" :placeholder="money2" type="number"
								 maxlength="15" :inputBorder='false' v-model="money2"></uni-easyinput>
						</view>
						<hr class="ms">
						<view class="seller">
							<image src="../../static/manual-entry/note.png.png (1).png" mode=""></image>
						...
						<view class="upload">
							...
							<view class="upload-right">
								...
								<uni-file-picker v-if="haveimg2 == 0" v-model="imageValue" fileMediatype="image"
									mode="grid" :limit="1" @select="select2" />
							</view>
						</view>
						<hr class="ms">
						<view class="tips">
