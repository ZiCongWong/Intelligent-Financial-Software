<template>
	<view class="con">
		<view class="main">
			...
			<view class="text-box">
				<view class="set-text">
					<p class="black">请设置密码</p>
				</view>
				
			</view>
			<view class="form">
				<view class="item" :class="'login_user ' + nameFocus">
					<input type="safe-password" class="input-ui u-border" placeholder="8-20位" :password="!showPassword" v-model="userpassword"/>
					<view class="showPwd">
			...
			<view class="tips-box">
				...
				<view class="all">
					<view class="tips">备注：请将密码设置为8-20位，并且由字母、数字和符号两种以上组合</view>

				</view>
			</view>
			<view class="botton-ui" @click="goIndex">
				<p class="denglu">完成</p>
			</view>
